...
- To check for sickness contamination between trials tested, and for evidence of carryover effects, paired samples t 
  tests were conducted --> no significant contamination across trials

### Results

- steering locomotion induced greater cybersickness than teleporting
  - however, a significant proportion of participants have higher FMS ratings for teleporting
  - differentiating into Steer-sick (15 participants) and Tele-sick (9 participants)
  - significantly greater medial-lateral postural sway (instability) found for Tele-sick group
- cybersickness increased with time in trial
- posture type (sit/stand) and participants not significant for cybersickness scores
- time in trial significant for steering locomotion, but not teleporting
- significant correlation between vection and cybersickness


### Discussion

- teleportation was found to produce less cybersickness than steering locomotion
  - no general advantage, as 9/25 participants reported greater cybersickness when continuously teleporting
  - steer-sick participants display different patterns of spontaneous postural instability before entering VR
- steering locomotion produces greater spatial presence and experienced realism than teleporting
  - overall presence ratings increase over time during steering locomotion, but not teleportation
- study failed to find significant relationship between presence and cybersickness
  - significant relationship between vection and cybersickness
  - --> cybersickness generated by HMD-based VR does not significantly inhibit the user's feelings of presence, 
    potentially because HMDs can induce much stronger feelings of presence than other types of VR and simulation


### Implications/Conclusions

- large individual differences in user responses
  - Teleporting did not reduce cybersickness in all users
  - Steering locomotion appeared to have different effects on male and female ratings of presence
- enabling realistic, comfortable virtual locomotion may require specific methods for different individuals and contexts
- neither sensory conflict, nor postural instability theories appeared to be able to fully account for incidence or 
  severity of cybersickness
- predictive role of postural stability for cybersickness incidence
  - provision of stable simulated reference frames may assist in reducing cybersickness for unstable participants
