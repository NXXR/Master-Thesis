...
\end{figure}
\footnotetext{The questionnaire was created using \href{https://www.google.com/forms/about/}{Google Forms}}
\newpage

\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth, page=2]{content/appendix/docs/CheckpointScenarioQuestionnaire}
    \caption{Feedback section for the checkpoints scenarios of the user study (page 2)\footnotemark.}
...
\begin{figure}[h]
    ...
    \caption{Example questions for the automatic navigation scenarios of the user study (page 1)\footnotemark.}
...
\begin{figure}[h]
    ...
    \caption{Feedback section for the automatic navigation scenarios of the user study (page 2)\footnotemark.}
