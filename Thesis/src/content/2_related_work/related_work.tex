...
\begin{center}
    ...
    \end{tabular}
    \captionof{table}{Questions and subscale groups, according to Gianaros et al.~\cite{Gianaros2001}}
...
\end{itemize}
While, Gianaros et al.~\cite{Gianaros2001} note that the generated symptoms during their study may stem from a
