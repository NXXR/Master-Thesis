...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{content/3_problems/img/6-DOF-reference[Fragaszy2018]}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{content/3_problems/img/OldAutomaticNavigation}
...
Figure~\ref{fig:old-auto-nav} describes the movement process during the automatic navigation.
...
\begin{wrapfigure}{o}{0.25\textwidth}
    \centering
    \includegraphics[width=0.1\textwidth]{content/3_problems/img/OldAutomaticNavigation_Landing}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.25\textwidth]{content/3_problems/img/OldAutomaticNavigation_SurfaceCollision}
