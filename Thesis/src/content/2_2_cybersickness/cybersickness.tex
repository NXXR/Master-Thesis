\section{Cybersickness}\label{sec:cybersickness}
...
The terms cybersickness and VR sickness will be used in this thesis, as Stanney, Kennedy, and
...
Together, the components function to compensate for movement, stabilize vision, maintain head posture, and maintain
...
changes in the subject's centre of gravity occur, and the subject's ability to maintain postural stability is
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{content/2_2_cybersickness/img/VergenceAccommodation[Kroeker2010]}
...
Other, more recent reviews, like Sevinc and Berkman~\cite{Sevinc2020}, and Rebenitsch and Owen~\cite{Rebenitsch2016},
...
Similar to the way Kennedy et al.\ \cite{Kennedy1993} refined the SSQ from the MSQ, Stone III reinterpreted the
SSQ results in a cybersickness context, and selected the symptoms clearly indicating cybersickness:
\begin{itemize}
    \item headache
    \item eyestrain
    \item nausea
...
motion sickness scoring methods support the validity of the resulting CSQ.
...
drums and not VR environments, Sevinc et al.~\cite{Sevinc2020} note in their review on cybersickness that the Motion
Sickness Assessment Questionnaire was used in several virtual reality and simulator studies in the
recent years.
...
Conversely, Keshavarz and Hecht also note the questionnaire's indifference to the physiological correlates or root
...
continuous stream of data to examine symptom development and causes over the duration of the virtual environment
...
\subsubsection{Centre of Gravity and Head Dispersion Measurements}\label{subsubsec:centre-of-gravity-and-head-dispersion-measurements}
...
symptoms, several mitigation techniques and best practices have proven effective and have found widespread adoption
