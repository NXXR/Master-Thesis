...
The default orbital distance for each body is relative to the body size, so the orbited body always occupies the
...
\footnotetext{The videos are also available at
\textit{\href{https://youtu.be/8hXcuZNVw2E}{youtu.be/8hXcuZNVw2E}} (old navigation)
and \textit{\href{https://youtu.be/MfVulsq_P4I}{youtu.be/MfVulsq_P4I}} (new navigation).}
...
The movement path is constructed using a uniform cubic b-spline.
